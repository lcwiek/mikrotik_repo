# Generated on Wed May 27 22:02:40 UTC 2026 by coding.lifestyle Studio
...
add list=clss_tor_exits address=150.40.126.168
add list=clss_tor_exits address=150.40.126.172
...
add list=clss_tor_exits address=167.172.108.109
...
add list=clss_tor_exits address=176.65.142.198
...
add list=clss_tor_exits address=185.249.198.156
...
add list=clss_tor_exits address=192.159.99.241
...
add list=clss_tor_exits address=195.154.170.135
...
add list=clss_tor_exits address=207.246.110.27
...
add list=clss_tor_exits address=212.227.41.30
...
add list=clss_tor_exits address=217.154.191.103
add list=clss_tor_exits address=217.28.130.96
...
add list=clss_tor_exits address=23.95.214.128
add list=clss_tor_exits address=24.203.156.90
...
add list=clss_tor_exits address=45.137.69.89
...
add list=clss_tor_exits address=45.138.16.153
...
add list=clss_tor_exits address=45.142.141.134
...
add list=clss_tor_exits address=45.154.98.47
...
add list=clss_tor_exits address=45.67.138.241
...
add list=clss_tor_exits address=45.88.186.199
add list=clss_tor_exits address=45.88.186.215
...
add list=clss_tor_exits address=62.192.174.40
...
add list=clss_tor_exits address=64.69.40.75
add list=clss_tor_exits address=64.94.85.248
add list=clss_tor_exits address=65.109.106.228
